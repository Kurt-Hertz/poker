...
void bet(){
    char input[6];
    int val;
    printf("Enter an amount you would like to bet, you could type 'bet 50'. \n");
    scanf("%5s", input);
...
void turn(){
    ...
    if(ptotal == 21){
        printf("Congrats! You got a blackjack!! Your payout is, %d.\n", (int)(pot*2));
        balance += (pot*2);
    }else{
        char input[6];
        scanf("%5s", input);
            ...
            if(strcmp(input,"hit") == 0){
                ...
                if(ptotal < 21){
                    if(nv==1){
                        if(ptotal+10 == 21){
                            ptotal += 10;
                            printf("Congrats! You got 21! Payout is.\n");
                            balance += (pot*2);                         
                            break;
                        }else{
                            int input;
